...
function EditCoupon() {
    ...
    const fetchData = async () => {
        try {
            console.log(userData?.vendor_id, param.id);
            await axios
                .get(`vendor/coupons-detail/${userData?.vendor_id}/${param.coupon_id}`)
                .then((res) => {
                    setCoupon(res.data);
                });
        } catch (error) {
    ...
    const handleUpdateCoupon = async (e) => {
        ...
        await axios
            .patch(`vendor/coupons-detail/${userData?.vendor_id}/${param.coupon_id}/`, formdata)
            .then((res) => {
