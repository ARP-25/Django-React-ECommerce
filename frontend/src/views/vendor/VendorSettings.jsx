...
function VendorSettings() {
    ...
    const fetchProfileData = async () => {
        try {
            axios.get(`vendor/profile-update/${userData?.user_id}/`).then((res) => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        const res = await axios.get(`vendor/profile-update/${userData?.user_id}/`);
    ...
    const handleShopFormSubmit = async (e) => {
        ...
        const res = await axios.patch(`vendor/shop-settings/${userData?.vendor_id}/`);
